...
var parse = require('@acuminous/bitsyntax').parse;
var build = require('@acuminous/bitsyntax').build;
var builder = require('@acuminous/bitsyntax').builder;
var write = require('@acuminous/bitsyntax').write;
