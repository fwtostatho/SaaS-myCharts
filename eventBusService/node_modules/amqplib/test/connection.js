...
var HB_BUF = require('amqplib/lib/frame').HEARTBEAT_BUF;
...
suite("Connection errors", function() {
  ...
  test("bad frame during open", function(done) {
    ...
    var conn = new (require('amqplib/lib/connection').Connection)(ss.client);
...
var heartbeat = require('amqplib/lib/heartbeat');
