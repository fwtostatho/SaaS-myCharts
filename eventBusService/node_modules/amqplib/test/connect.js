...
var connect = require('amqplib/lib/connect').connect;
var credentialsFromUrl = require('amqplib/lib/connect').credentialsFromUrl;
var defs = require('amqplib/lib/defs');
var assert = require('assert');
var util = require('amqplib/test/util');
var net = require('net');
...
suite("Connect API", function() {
  ...
  test("using plain credentials", function(done) {
    ...
    connect(URL, {credentials: require('amqplib/lib/credentials').plain(u, p)},
  ...
  test("using amqplain credentials", function(done) {
    ...
    connect(URL, {credentials: require('amqplib/lib/credentials').amqplain(u, p)},
            kCallback(succeed(done), fail(done)));
  });
