...
var succeed = require('amqplib/test/util').succeed;
var fail = require('amqplib/test/util').fail;
var connection = require('amqplib/lib/connection');
var Frames = connection.Connection;
var HEARTBEAT = require('amqplib/lib/frame').HEARTBEAT;
...
var amqp = require('amqplib/test/data');
...
var assertEqualModuloDefaults =
  require('amqplib/test/codec').assertEqualModuloDefaults;
