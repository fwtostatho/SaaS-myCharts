...
var frame = require('amqplib/lib/frame');
var HEARTBEAT = frame.HEARTBEAT;
var Mux = require('amqplib/lib/mux').Mux;

var Duplex =
  require('stream').Duplex ||
  require('readable-stream/duplex');
var EventEmitter = require('events').EventEmitter;
var Heart = require('amqplib/lib/heartbeat').Heart;

var methodName = require('amqplib/lib/format').methodName;
var closeMsg = require('amqplib/lib/format').closeMessage;
var inspect = require('amqplib/lib/format').inspect;

var BitSet = require('amqplib/lib/bitset').BitSet;
var inherits = require('util').inherits;
var fmt = require('util').format;
var PassThrough = require('stream').PassThrough ||
  require('readable-stream/passthrough');
var IllegalOperationError = require('amqplib/lib/error').IllegalOperationError;
var stackCapture = require('amqplib/lib/error').stackCapture;
